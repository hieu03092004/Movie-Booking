    ...
    pool
      ...
      .then(() => {
        ...
        requestPrice.query(sqlQueryPrice, (error, results) => {
          ...
          const priceArray = prices.flatMap((subArray) =>
            subArray.map((item) => item.price)
          );
          ...
          if (dayOfWeek != "Saturday" && dayOfWeek != "Sunday") {
            priceArray.forEach((price, index) => {
              if (index == 0) priceArray[index] = 60000;
              if (index == 1) priceArray[index] = 90000;
            });
          } else {
            priceArray.forEach((price, index) => {
              if (index == 0) priceArray[index] = 90000;
              if (index == 1) priceArray[index] = 120000;
            });
          }
        ...
        seatArray.forEach((seat) => {
          ...
          if (dayOfWeek != "Saturday" && dayOfWeek != "Sunday") {
            if (column == "A" || column == "B") {
              totalPayment += 60000;
            } else totalPayment += 90000;
          } else {
            if (column == "A" || column == "B") {
              totalPayment += 90000;
            } else totalPayment += 120000;
          }
        });
